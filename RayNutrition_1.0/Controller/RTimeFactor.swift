...
class RTimeFactor: BaseCell, UIPickerViewDelegate, UIPickerViewDataSource {
   ...
   let gradeTextField: UITextField = {
    ...
    func setupButton(){
       ...
       @objc func buttonClicked() {
        ...
        NotificationCenter.default.post(name: NSNotification.Name("Луч Возврата"), object: nil)
